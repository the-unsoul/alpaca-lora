...
def main(
    ...
    base_model: str = "samwit/koala-7b",
    lora_weights: str = "tloen/alpaca-lora-7b",
    prompt_template: str = "generate_question",  # The prompt template to use, will default to alpaca.
):
